                    ...
                    <td>
                        @foreach ($item->getRelations() as $relationName => $relation)
                            ...
                            <strong>{{ ucfirst($relationName) }}:</strong> {{ ($relation?->name ? $relation->name : ($relation?->policy_number ?
                                $relation?->policy_number  : ($relation?->reason_for_appointment ? $relation?->reason_for_appointment : ($relation?->state ? $relation?->state : ($relation?->result ? $relation?->result : $relation?->medicine) )))) ?? 'N/A'
                            }}
                            @endif
                        @endforeach
                    </td>
