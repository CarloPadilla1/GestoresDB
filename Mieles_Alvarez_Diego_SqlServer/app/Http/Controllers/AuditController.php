...
class AuditController extends Controller
{
    ...
    public function generateTriggersSql()
    {
        ...
        $tables = DB::select("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE' AND TABLE_NAME <> 'Audit'");
    ...
    private function generateTriggerSql($tableName, $actionType) {
        ...
        BEGIN
            ...
            VALUES ('$tableName', '$actionType', SYSTEM_USER, '${actionType}d record');
        END;
        ";
