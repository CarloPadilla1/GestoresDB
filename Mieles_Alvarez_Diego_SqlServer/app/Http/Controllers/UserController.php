...
class UserController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.admin_users.edit',compact('user', 'databases', 'permissions', 'all_permissions'));
    }
    ...
    public function updateRolesUM(Request $request, $id)
    {
        $request->validate([
            'role*' => 'required'
        ]);
        try{
            $this->serviceUsers->updateRolesUserMap($request->all(), $id);
